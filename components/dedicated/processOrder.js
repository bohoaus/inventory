      ...
      <div id="processOrderModal" class="modal">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group-dispatch" style="display: grid; grid-template-columns: auto auto auto;">
            ...
            <div class="form-group-order-dispatch required">
              ...
              <div class="form-group-order-dispatch">
                ...
                <textarea id="orderNotes" rows="3" value='OK' style="width: 200px; color:red; maxlength:50"></textarea>
              </div>
            </div>
