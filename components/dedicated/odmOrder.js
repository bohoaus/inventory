            ...
            <div class="odm-form2">
                <div class="customer-info2">
                    <div class="form-group-odm-order required">
                        <label for="customer_name" style="width: 120px">Customer Name</label>
                        <input type="text" id="customer_name" style="width: 350px" maxlength="40">
                ...
                <div class="customer-info2">
                    <div class="form-group-odm-order required">
                        <label for="agent_state" style="width: 100px;color: grey">Agent State</label>
                    ...
                    <div class="form-group-odm-order">
                        <label for="osite" style="color: grey">Location</label>
                        <input type="text" id="osite" placeholder="Floor" value="Floor" maxlength="10" style="width:100px; color: blue">
                    </div>
                    <div class="form-group-odm-order">
                        <label for="dispatched_box" style="color: grey">Boxes</label>
                    ...
                    <div class="form-group-odm-order">
                        ...
                        <input type="text" id="invoice_no" value="12173600" maxlength="10" style="width: 90px; color: blue">
                    </div>

                    <div class="form-group-odm-order required">
                      <label for="ocountry" style="color: grey">Country</label>
                ...
                <div class="customer-info2">
                  ...
                  <div class="form-group-odm-order">
                    ...
                    <div class="form-group-odm-order">
                        ...
                        <input type="text" id="odisc" placeholder="00.00" value="0.00" maxlength="5" style="width: 50px; color: blue">
                    </div>
                </div>
