            ...
            <div class="wholesale-form">
                <div class="customer-info">
                    ...
                    <div class="form-group">
                        ...
                        <input style="width: 80px" type="text" id="invoice_no" value="12171400" maxlength="10">
                    </div>
                </div>
...
//        `;
  ...
  selectItem(item) {
    ...
    document.getElementById("itemRelease").textContent = new Date(item.release_date).toISOString() || "";
