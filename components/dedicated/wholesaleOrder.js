            ...
            <div class="wholesale-form">
                <div class="customer-info">
                    <div class="form-group">
                        ...
                        <input type="text" id="customer_name" required style="width: 350px" maxlength="37">
                    ...
                    <div class="form-group">
                        ...
                        <input style="width: 80px" type="text" id="invoice_no" value="12173400" maxlength="10">
                    </div>
                </div>
                ...
                <div class="customer-wholesale">
                  <div class="item-search">
                    <div class="form-group-wholesale-order" style="display: flex; flex-direction: row; width: 400px">
                        ...
                        <input type="text" id="itemSearch" placeholder="Enter Item Code or Name" maxlength="20" style="width: 500px; color: blue">
...
//    let itemDiscount = document.getElementById("orderDiscount").textContent;
    ...
    document.getElementById("orderDiscount").textContent = item.odisc || "0";
...
//jimm-this one is ok-2025.05.05
